...
nasm -f elf64 -l get_values.lis -o get_values.o get_values.asm -g -gdwarf

echo "Assemble the X86 file sum_values.asm"
nasm -f elf64 -l sum_values.lis -o sum_values.o sum_values.asm -g -gdwarf
...
g++ -c -m64 -Wall -std=c++17 -fno-pie -no-pie -o assessor.o assessor.cpp -g

echo "Compile the C file show_values.c"
gcc -c -Wall -m64 -no-pie -o show_values.o show_values.c -std=gnu11 -lm -g

echo "Link the three files isFloat.o driver2.o compute_time.o"
g++ -m64 -std=c++17 -fno-pie -no-pie -o output.out isfloat.o assessor.o manager.o get_values.o show_values.o sum_values.o -g
